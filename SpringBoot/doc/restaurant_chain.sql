...
CREATE TABLE `reviews`  (
  ...
  UNIQUE INDEX `order_id`(`order_id` ASC) USING BTREE COMMENT '一个订单只能评价一次',
  INDEX `user_id`(`user_id` ASC) USING BTREE,
  INDEX `store_id`(`store_id` ASC) USING BTREE,
  ...
  CONSTRAINT `reviews_ibfk_3` FOREIGN KEY (`store_id`) REFERENCES `stores` (`store_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of reviews
-- ----------------------------
INSERT INTO `reviews` VALUES (1, 29, 1, 1, 5, '这家餐厅的招牌奶茶味道真不错，配送也很快，下次还会再点！', '2025-03-10 10:00:00');
INSERT INTO `reviews` VALUES (2, 30, 1, 1, 4, '黑糖珍珠奶茶很好喝，但是感觉珍珠有点少。总体还行。', '2025-03-11 11:30:00');
INSERT INTO `reviews` VALUES (3, 36, 6, 1, 5, '芝士奶盖茶是我的最爱！这家店做得非常正宗，强烈推荐！', '2025-03-12 14:00:00');
