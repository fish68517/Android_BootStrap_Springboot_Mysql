...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '游戏评论表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `comments` VALUES (4, 1, 6, '22222', 'approved', '2025-11-12 17:46:35', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '游戏信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `games` VALUES (2, 2, '秘境守护者', '一款奇幻RPG游戏，等待审核。', '/image/mijing_cover.png', NULL, 'approved', '2025-11-08 13:43:41', NULL, '2025-11-12 22:37:02');
INSERT INTO `games` VALUES (3, 2, '城市天际线MOD', '非官方作品，已被退回。', '/image/mijing_cover.png', NULL, 'pending', '2025-11-08 13:43:41', 1, NULL);
INSERT INTO `games` VALUES (4, 3, '开心农场乐园', '休闲模拟经营游戏。', '/image/farm_cover.jpg', '/image/farm_1.jpg,/image/farm_2.jpg', 'pending', '2025-11-08 13:43:41', 1, NULL);
INSERT INTO `games` VALUES (9, 9, 'DNF', 'DNF 是腾讯出品的一款很好玩游戏', '/img/ace94466-75ee-42a7-83a3-b4480f693646.jpeg', '/img/d464180b-1fc0-43cb-bb05-c7cc9c0664a8.jpg', 'approved', '2025-11-12 18:09:03', NULL, '2025-11-12 22:36:32');
...
INSERT INTO `user_favorites` VALUES (8, 9, '2025-11-13 12:30:15');
INSERT INTO `user_favorites` VALUES (9, 1, '2025-11-12 18:10:57');
...
INSERT INTO `users` VALUES (6, '128900@qq.com', '$2a$10$4FLM3M3cPmypDCFdxB2t9.hyYDj.ysGOLumPRr05iCP8Moq6DLGR6', '游戏玩家小张', 'user', '2025-11-12 16:55:09');
INSERT INTO `users` VALUES (8, '1289@qq.com', '$2a$10$PORR4U3RLeI7FyqXa2hZV.JLNPyH3E4WvWzgWl4EjQnLUnSQ1DSDC', '游戏玩家小李', 'user', '2025-11-12 16:56:49');
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '游戏撤回审核表' ROW_FORMAT = DYNAMIC;
